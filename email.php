...
if(isset($_POST['submit']) and !empty($_POST['submit'])){
    ...
    $mail1_subject="Makeover Avenue Enquiry from Google Ads, " . $name;
    ...
    $apiKey = urlencode('EEx3hTEycIfe2yFg');
    $utm_id = "8960743138";
    $agent = "51865614";
...
// More headers
$headers .= 'From: <makeoveravenueclt@gmail.com>' . "\r\n";

$to = "viralmafiacs2@gmail.com, cyril.viralmafia@gmail.com, leads.viralmafia@gmail.com";
$url = 'http://viralmafia.com/demo/jsonmailermakeover.php';
$ch = curl_init($url);
$data = array(
    'to' => $to,
